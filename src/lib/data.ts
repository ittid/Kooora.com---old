...
export const topMatches: Match[] = [
  ...
  {
    id: "m3",
    home: { name: "الترجي الرياضي", logo: "https://picsum.photos/seed/esperance/40" },
    away: { name: "اتحاد بن قردان", logo: "https://picsum.photos/seed/bgardane/40" },
    time: "14:30",
    status: "scheduled",
    dayLabel: "اليوم",
  },
  ...
  {
    id: "m5",
    home: { name: "العربي", logo: "https://picsum.photos/seed/arabi/40" },
    away: { name: "الدحيل", logo: "https://picsum.photos/seed/duhail/40" },
    time: "17:30",
    status: "scheduled",
    dayLabel: "اليوم",
  },
  {
    id: "m6",
    home: { name: "شباب رياضي بلوزداد", logo: "https://picsum.photos/seed/crb/40" },
    away: { name: "هلال شلفون العيد", logo: "https://picsum.photos/seed/hco/40" },
    time: "15:00",
    status: "scheduled",
    dayLabel: "اليوم",
  },
